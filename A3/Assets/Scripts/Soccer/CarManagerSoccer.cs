...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarManagerSoccer : CarManager
    {
        ...
        private CarController m_Car; // the drone controller we want to use
        ...
        private Vector3 findBallVelocityToAdd(Vector3 dirObj)  // todo look if angle < 90°
        {
        ...
        private void PDcontroller(Vector3 targetPos)
        {
            ...
            bool is_to_the_right = Vector3.Dot(desiredAcceleration, transform.right) > 0f;
            bool is_to_the_front = Vector3.Dot(desiredAcceleration, transform.forward) > 0f;
            float steering = 0f;
            ...
            car.Move(steering, desiredAcceleration.magnitude, desiredAcceleration.magnitude, 0f);
        }
        ...
        bool GoSolution()
        {
            ...
            // m_Car.Move_vect(direction); // move the robot
            PDcontroller(direction); // move the robot
            return true;
        }
